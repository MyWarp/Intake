...
import com.sk89q.intake.example.parametric.TempUtil;
...
public class I18nUniverseCommands {
  ...
  @Command(aliases = "setdesc", desc = "cmd.setdesc.desc")
  ...
  @Command(aliases = "info", desc = "cmd.info.desc")
  @Require("body.info")
  public void info(Body body, @Switch('f') boolean inFahrenheit) {
    System.out.println(msg.getString("cmd.info.type", body.getType()));

    if (inFahrenheit) {
      System.out.println(msg.getString("cmd.info.temp", TempUtil.celsiusToFahrenheit(body.getMeanTemperature()), msg.getString("cmd.info.temp.fahrenheit")));
    } else {
      System.out.println(msg.getString("cmd.info.temp", body.getMeanTemperature(), msg.getString("cmd.info.temp.celsius")));
    }

    if (body.getDescription() != null) {
      System.out.println(msg.getString("cmd.info.description", body.getDescription()));
    }
  }

  @Command(aliases = "delete", desc = "cmd.delete.desc")
